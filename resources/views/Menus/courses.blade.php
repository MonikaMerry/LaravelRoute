...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3">
        <div class="container">
            <a class="navbar-brand fw-bold fs-3 link-info" href="#">COURSES</a>
    ...
    <div class="container black">
        <h1>Courses</h1> <br>
        <h4 class="text-middle">There are so many courses are available some courses are listed below</h4>
        <ul class="list-unstyled fs-6 mt-4">
            <li>HTML&CSS</li>
            <li>JavaScript</li>
            <li>node.JS</li>
            <li>PHP</li>
            <li>Hacking Courses</li>
        </ul><br>
    </div>
